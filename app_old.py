...
class ImprovedArticleGenerator:
    ...
    def generate_article(self, transcription: str, shop_info: Dict[str, str]) -> Dict[str, any]:
        ...
        try:
            ...
            # タイトル生成（簡潔版）
            title = f"{shop_name}に行ってきました！{shop_location}の{shop_category}をレポート"
...
class QualityChecker:
    ...
    def check_article_quality(self, content: str) -> Dict[str, any]:
        ...
        # まるつー風チェック（改良版）
        marutsu_words = ['取材', 'レポート', 'チェック', '♪', '〜！', '行ってきました', 'よかったです']
...
article_generator = ImprovedArticleGenerator()
